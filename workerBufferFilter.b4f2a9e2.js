...
},{"quickselect":"../node_modules/quickselect/quickselect.js"}],"../node_modules/geojson-rbush/node_modules/@turf/helpers/index.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/geojson-rbush/node_modules/@turf/meta/index.js":[function(require,module,exports) {
'use strict';
...
},{"@turf/helpers":"../node_modules/geojson-rbush/node_modules/@turf/helpers/index.js"}],"../node_modules/@turf/helpers/main.es.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/@turf/meta/main.es.js":[function(require,module,exports) {
"use strict";
...
},{"@turf/helpers":"../node_modules/@turf/helpers/main.es.js"}],"../node_modules/@turf/bbox/main.es.js":[function(require,module,exports) {
"use strict";
...
},{"@turf/meta":"../node_modules/@turf/meta/main.es.js"}],"../node_modules/geojson-rbush/index.js":[function(require,module,exports) {
...
},{"rbush":"../node_modules/rbush/index.js","@turf/helpers":"../node_modules/geojson-rbush/node_modules/@turf/helpers/index.js","@turf/meta":"../node_modules/geojson-rbush/node_modules/@turf/meta/index.js","@turf/bbox":"../node_modules/@turf/bbox/main.es.js"}],"src/entities/workerBufferFilter.js":[function(require,module,exports) {
...
function computeDataForBufferGraph(classKeys, features, valFeatures) {
  ...
  var polygonBufferFilter = [];

  for (var bufferSize = min; bufferSize <= max; bufferSize += step) {
    polygonBufferFilter.push(computeBufferAuxiliary(valFeatures, bufferSize));
  }

  var bufferTesselate = [];

  for (var _i = 0, _polygonBufferFilter = polygonBufferFilter; _i < _polygonBufferFilter.length; _i++) {
    var feat = _polygonBufferFilter[_i];
    var bufTesselate = turf.tesselate(feat).features;
    bufferTesselate.push(bufTesselate);
  }

  var pos = min;

  for (var _i2 = 0, _bufferTesselate = bufferTesselate; _i2 < _bufferTesselate.length; _i2++) {
    var polyBuffer = _bufferTesselate[_i2];
    dataArea = calcOccupiedAreaForEachClass(classKeys, features, polyBuffer);
    var oaValue = computeOA(dataArea);
    var paValue = computeRecall(dataArea);
    var uaValue = computePrecision(dataArea);
    var f1score = computeF1(dataArea);
...
function computeBufferAuxiliary(valFeatures, value) {
  ...
  for (var index = 0, len = valFeatures.length; index < len; ++index) {
    var feat = valFeatures[index];

    if (feat.properties.classId == 1) {
      var featBuffer = void 0;
      var bufferLine = feat;
...
function computeOA(dataToComputeMetrics) {
  ...
  for (var index = 0; index < lenData; index++) {
    var element = dataToComputeMetrics[index];
...
function computeF1(dataToComputeMetrics) {
...
function computePrecision(dataToComputeMetrics) {
...
function computeRecall(dataToComputeMetrics) {
  ...
  for (var index = startLine; index < lenData; index += step) {
    divisor += dataToComputeMetrics[index];
  }
...
function calcOccupiedAreaForEachClass(classKeys, features, polygonBufferTesselated) {
  ...
  for (var index = 0, len = classKeys.length; index < len; index++) {
    var key = classKeys[index];
  ...
  for (var _index = 0, _len = features.length; _index < _len; _index++) {
    var polygon = features[_index]; //Convert area to hectares (ha = m^2 / 10000)

    calcArea = turf.area(polygon) / 10000;
    var newPoly = turf.tesselate(polygon).features;

    var _iterator = _createForOfIteratorHelper(newPoly),
        _step;

    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var newP = _step.value;
    ...
    newFeatures.push.apply(newFeatures, _toConsumableArray(newPoly));
  }
  ...
  var _iterator2 = _createForOfIteratorHelper(polygonBufferTesselated),
      _step2;

  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var drawP = _step2.value;
      var drawPArea = turf.area(drawP);
      containElements = rbush.search(drawP).features;

      for (var _index2 = 0, _len2 = containElements.length; _index2 < _len2 && drawP; ++_index2) {
        calcArea = 0;
        var _polygon = containElements[_index2];
        var pos = classIndex[parseInt(_polygon['properties']['classId'])];

        try {
          calcArea = drawPArea - turf.area(turf.difference(drawP, _polygon)); // eslint-disable-next-line no-empty
        } catch (error) {}
...
},{"@turf/turf":"../node_modules/@turf/turf/turf.min.js","geojson-rbush":"../node_modules/geojson-rbush/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/entities/workerBufferFilter.js"], null)
//# sourceMappingURL=/workerBufferFilter.b4f2a9e2.js.map