...
export class ReadFiles{
    ...
    readValidation(){
        return JSON.parse(readFileSync('./workspace/static/data/faixas_combustao/validation_out.geojson', 'utf8').trim());
    }

    readClassification(){
        return JSON.parse(readFileSync('./workspace/static/data/faixas_combustao/classification_out.geojson', 'utf8').trim());
    }
