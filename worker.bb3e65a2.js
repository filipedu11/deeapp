...
},{"rbush":"../node_modules/rbush/index.js","@turf/helpers":"../node_modules/geojson-rbush/node_modules/@turf/helpers/index.js","@turf/meta":"../node_modules/geojson-rbush/node_modules/@turf/meta/index.js","@turf/bbox":"../node_modules/@turf/bbox/main.es.js"}],"src/entities/worker.js":[function(require,module,exports) {
...
function calcOccupiedAreaForEachClass(classKeys, features, filterAreaInterval, polygonFilter) {
  ...
  if (polygonFilter) {
    ...
    var count = 0;
    var lendra = drawPolygons.length;

    var _iterator2 = _createForOfIteratorHelper(drawPolygons),
        _step2;
    ...
    for (var _index3 = 0, _len3 = features.length; _index3 < _len3; _index3++) {
      var _polygon2 = features[_index3];
      var _pos = classIndex[parseInt(_polygon2['properties']['classId'])]; //Convert area to hectares (ha = m^2 / 10000)

      calcArea = turf.area(_polygon2) / 10000;

      if (!filterAreaInterval || filterAreaInterval[0] <= calcArea && calcArea <= filterAreaInterval[1]) {
        dataArea[_pos] += calcArea;
      }
    }
  }
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/entities/worker.js"], null)
//# sourceMappingURL=/worker.bb3e65a2.js.map